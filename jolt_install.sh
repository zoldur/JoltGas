...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='joltgas.conf'
CONFIGFOLDER='/root/.joltgas'
COIN_DAEMON='/usr/local/bin/joltgasd'
COIN_CLI='/usr/local/bin/joltgasd'
COIN_REPO='https://github.com/JoltDev/Jolt-Gas/releases/download/1.0.0/joltgas-daemon-1.0.0.zip'
COIN_NAME='JoltGas'
COIN_PORT=2333
RPCPORT=2334
